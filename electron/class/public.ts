...
class Public {
   ...
   */
  get_language_path() {
    return path.resolve(this.get_resource_path(), "languages");
  }
  ...
  get_root_path(): string {
    ...
    // return result;
    return path.resolve(this.get_resource_path(), "../", "../");
  }
  ...
  getCurrentDateTime = () => {
    ...
    // 星期几
    const weekDay = [this.lang("星期日"), this.lang("星期一"), this.lang("星期二"), this.lang("星期三"), this.lang("星期四"), this.lang("星期五"), this.lang("星期六")][now.getDay()];
